...
.method constructor <init>(Lcom/google/android/gms/common/api/internal/GoogleApiManager;ILcom/google/android/gms/common/api/internal/ApiKey;JJLjava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lcom/google/android/gms/common/api/internal/zacb;->zaa:Lcom/google/android/gms/common/api/internal/GoogleApiManager;

    iput p2, p0, Lcom/google/android/gms/common/api/internal/zacb;->zab:I

    iput-object p3, p0, Lcom/google/android/gms/common/api/internal/zacb;->zac:Lcom/google/android/gms/common/api/internal/ApiKey;

    iput-wide p4, p0, Lcom/google/android/gms/common/api/internal/zacb;->zad:J

    iput-wide p6, p0, Lcom/google/android/gms/common/api/internal/zacb;->zae:J

    return-void
.end method

.method static zaa(Lcom/google/android/gms/common/api/internal/GoogleApiManager;ILcom/google/android/gms/common/api/internal/ApiKey;)Lcom/google/android/gms/common/api/internal/zacb;
    .locals 12
    ...
    .line 5
    invoke-virtual {p0, p2}, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zai(Lcom/google/android/gms/common/api/internal/ApiKey;)Lcom/google/android/gms/common/api/internal/zabo;

    move-result-object v1

    if-eqz v1, :cond_3

    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/zabo;->zaf()Lcom/google/android/gms/common/api/Api$Client;
    ...
    .line 9
    invoke-static {v1, v2, p1}, Lcom/google/android/gms/common/api/internal/zacb;->zab(Lcom/google/android/gms/common/api/internal/zabo;Lcom/google/android/gms/common/internal/BaseGmsClient;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    .line 10
    invoke-virtual {v1}, Lcom/google/android/gms/common/api/internal/zabo;->zaq()V
    ...
    :cond_3
    :goto_1
    new-instance v11, Lcom/google/android/gms/common/api/internal/zacb;
    ...
    invoke-direct/range {v1 .. v10}, Lcom/google/android/gms/common/api/internal/zacb;-><init>(Lcom/google/android/gms/common/api/internal/GoogleApiManager;ILcom/google/android/gms/common/api/internal/ApiKey;JJLjava/lang/String;Ljava/lang/String;)V

    return-object v11
.end method

.method private static zab(Lcom/google/android/gms/common/api/internal/zabo;Lcom/google/android/gms/common/internal/BaseGmsClient;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    .locals 2
    ...
    :cond_2
    :goto_0
    invoke-virtual {p0}, Lcom/google/android/gms/common/api/internal/zabo;->zac()I
...
.method public final onComplete(Lcom/google/android/gms/tasks/Task;)V
    ...
    .line 1
    iget-object v1, v0, Lcom/google/android/gms/common/api/internal/zacb;->zaa:Lcom/google/android/gms/common/api/internal/GoogleApiManager;
    ...
    :cond_1
    iget-object v2, v0, Lcom/google/android/gms/common/api/internal/zacb;->zaa:Lcom/google/android/gms/common/api/internal/GoogleApiManager;

    iget-object v3, v0, Lcom/google/android/gms/common/api/internal/zacb;->zac:Lcom/google/android/gms/common/api/internal/ApiKey;

    .line 4
    invoke-virtual {v2, v3}, Lcom/google/android/gms/common/api/internal/GoogleApiManager;->zai(Lcom/google/android/gms/common/api/internal/ApiKey;)Lcom/google/android/gms/common/api/internal/zabo;

    move-result-object v2

    if-eqz v2, :cond_b

    invoke-virtual {v2}, Lcom/google/android/gms/common/api/internal/zabo;->zaf()Lcom/google/android/gms/common/api/Api$Client;
    ...
    iget-wide v4, v0, Lcom/google/android/gms/common/api/internal/zacb;->zad:J
    ...
    iget v4, v0, Lcom/google/android/gms/common/api/internal/zacb;->zab:I

    .line 13
    invoke-static {v2, v3, v4}, Lcom/google/android/gms/common/api/internal/zacb;->zab(Lcom/google/android/gms/common/api/internal/zabo;Lcom/google/android/gms/common/internal/BaseGmsClient;I)Lcom/google/android/gms/common/internal/ConnectionTelemetryConfiguration;
    ...
    iget-wide v3, v0, Lcom/google/android/gms/common/api/internal/zacb;->zad:J
    ...
    :goto_2
    iget-object v5, v0, Lcom/google/android/gms/common/api/internal/zacb;->zaa:Lcom/google/android/gms/common/api/internal/GoogleApiManager;
    ...
    .line 16
    iget-wide v6, v0, Lcom/google/android/gms/common/api/internal/zacb;->zad:J

    iget-wide v9, v0, Lcom/google/android/gms/common/api/internal/zacb;->zae:J
    ...
    :goto_6
    iget v10, v0, Lcom/google/android/gms/common/api/internal/zacb;->zab:I
